<section class="products" data-module="OPA">
  <div class="container">
    <div class="title title--with-icon">
      <h2 class="title__header">Poslastice</h2>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/dessert.svg" alt="" class="title__icon">
    </div>
    <div>
      <?php 
